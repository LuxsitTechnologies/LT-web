  ...
  return (
    <section className="bg-black text-white py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 p-20 md:p-0  sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service) => (
            <div
              key={service.id}
              className="p-4 md:p-6 rounded-lg border-2 border-[#1d1d1d] bg-[url('https://cdn.prod.website-files.com/6489396f0421491be30aa786/648939700421491be30aa9da_noise.webp')] bg-[length:800px_800px] bg-repeat"
            >
              ...
              <div className="text-blue-400 mb-2 text-center">
                {service.id}
              </div>
